...
namespace HoloToolkit.Unity
{
    ...
    public partial class GestureManager : Singleton<GestureManager>
    {
        ...
        private UnityEngine.XR.WSA.Input.InteractionSourceState currentHandState;
        ...
        private void GestureRecognizer_RecognitionStartedEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Ray headRay)
        {
            OnRecognitionStarted();
        }

        private void GestureRecogniser_RecognitionEndedEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Ray headRay)
        {
        ...
        private void ManipulationRecognizer_ManipulationStartedEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headRay)
        {
        ...
        private void ManipulationRecognizer_ManipulationUpdatedEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headRay)
        {
            OnManipulation(true, cumulativeDelta);
        }

        private void ManipulationRecognizer_ManipulationCompletedEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headRay)
        {
        ...
        private void ManipulationRecognizer_ManipulationCanceledEvent(UnityEngine.XR.WSA.Input.InteractionSourceKind source, Vector3 cumulativeDelta, Ray headRay)
        {
            OnManipulation(false, cumulativeDelta);
