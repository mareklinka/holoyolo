        ...
        public IEnumerator Import_UnderstandingMesh()
        {
                ...
                (meshIndices.Length > 0))
            {
                ...
                foreach (MeshData meshdata in meshSectors.Values)
                {
                    ...
                    AddSurfaceObject(meshdata.MeshObject, string.Format("SurfaceUnderstanding Mesh-{0}", transform.childCount), transform).AddComponent<UnityEngine.XR.WSA.WorldAnchor>();
