...
namespace HoloToolkit.Unity
{
    ...
    public class StabilizationPlaneModifier : Singleton<StabilizationPlaneModifier>
    {
        ...
        private void ConfigureTransformOverridePlane()
        {
            ...
            UnityEngine.XR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -Camera.main.transform.forward, velocity);
        }
        ...
        private void ConfigureFixedDistancePlane()
        {
            ...
            UnityEngine.XR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -Camera.main.transform.forward, Vector3.zero);
        }
